...
pub const BOOT_IMAGE_DATA_SIZE: usize = BOOT_IMAGE_CODE_START - BOOT_IMAGE_DATA_START;

/** The current boot image code size */
pub const BOOT_IMAGE_CODE_SIZE: usize = BOOT_IMAGE_RMAP_START - BOOT_IMAGE_CODE_START;
...
pub const BOOT_IMAGE_DATA_END: Address = BOOT_IMAGE_DATA_START + BOOT_IMAGE_DATA_SIZE;

/** The address of the end of the code section of the boot image. */
pub const BOOT_IMAGE_CODE_END: Address = BOOT_IMAGE_CODE_START + BOOT_IMAGE_CODE_SIZE;

/** The address of the end of the ref map section of the boot image. */
pub const BOOT_IMAGE_RMAP_END: Address = BOOT_IMAGE_RMAP_START + MAX_BOOT_IMAGE_RMAP_SIZE;
