...
pub trait ActivePlan<VM: VMBinding> {
    ...
    unsafe fn collector(tls: OpaquePointer) -> &'static mut <SelectedPlan as Plan<VM>>::CollectorT;
    unsafe fn is_mutator(tls: OpaquePointer) -> bool;
    unsafe fn mutator(tls: OpaquePointer) -> &'static mut <SelectedPlan as Plan<VM>>::MutatorT;
    fn collector_count() -> usize;
    fn reset_mutator_iterator();
    fn get_next_mutator() -> Option<&'static mut <SelectedPlan as Plan<VM>>::MutatorT>;
}