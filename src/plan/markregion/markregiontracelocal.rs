...
impl TraceLocal for MarkRegionTraceLocal {
    ...
    fn trace_object(&mut self, object: ObjectReference) -> ObjectReference {
        ...
        if PLAN.space.in_space(object) {
            // println!("t start");
            let o = PLAN.space.trace_object(self, object);
            // println!("t end");
            return o;
        }
        ...
        PLAN.print_vm_map();
        panic!("No special case for space in trace_object, object = {:?} {}", object, PLAN.space.contains(object));
    }
    ...
    fn is_live(&self, object: ObjectReference) -> bool {
        ...
        if PLAN.space.in_space(object) {
            ...
            PLAN.versatile_space.is_live(object)
